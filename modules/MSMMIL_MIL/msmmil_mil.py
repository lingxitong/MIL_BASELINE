"""
MSMMIL_MIL - Multi-Scale Mamba-based Multiple Instance Learning
"""
import torch
...
try:
    from mamba.mamba_ssm import SRMamba, BiMamba, Mamba, MultiMamba
except ImportError:
    print("Warning: mamba-ssm not installed. Please install it: pip install mamba-ssm")
...
class MSMMIL_MIL(nn.Module):
    ...
    def __init__(self, in_dim=1024, num_classes=2, dropout=0.1, act=nn.ReLU(), 
        ...
        super(MSMMIL_MIL, self).__init__()
