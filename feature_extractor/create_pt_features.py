...
parser.add_argument('--backbone', default='gigapath',type=str,choices=['vit_s_imagenet','resnet50_imagenet','plip','conch','uni','ctranspath','gigapath','virchow','virchow_v2','conch_v1_5','uni_v2','hoptimus_v1','midnight'], help='backbone model')
