...
def process_LONG_MIL(args):
    ...
    alibi_position_embedding_path = args.Model.alibi_position_embedding_path
    version = args.Model.version
    mil_model = LONG_MIL(num_classes,in_dim,hidden_dim,alibi_position_embedding_path,version)
    mil_model.to(device)
