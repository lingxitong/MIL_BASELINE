...
def process_PA_MIL(args):
    ...
    # PA_MIL specific parameters
    embed_dim = args.Model.embed_dim if hasattr(args.Model, 'embed_dim') else 128
    num_layers = args.Model.num_layers if hasattr(args.Model, 'num_layers') else 1
