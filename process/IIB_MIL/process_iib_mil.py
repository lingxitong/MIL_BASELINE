...
def process_IIB_MIL(args):
    ...
    dim = args.Model.dim if hasattr(args.Model, 'dim') else 256
    depth = args.Model.depth if hasattr(args.Model, 'depth') else 3
    num_queries = args.Model.num_queries if hasattr(args.Model, 'num_queries') else 5
