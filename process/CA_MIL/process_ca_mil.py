...
def process_CA_MIL(args):
    ...
    mil_model = CA_MIL(L=L, D=D, num_classes=num_classes, dropout=dropout, act=act, in_dim=in_dim)
    mil_model.to(device)
    ...
    save_last_model(args, mil_model.state_dict())
    save_log(args, epoch_info_log)
