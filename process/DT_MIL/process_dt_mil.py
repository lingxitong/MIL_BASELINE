...
def process_DT_MIL(args):
    ...
    # DT_MIL specific parameters
    d_model = args.Model.d_model if hasattr(args.Model, 'd_model') else 512
    n_heads = args.Model.n_heads if hasattr(args.Model, 'n_heads') else 8
    num_encoder_layers = args.Model.num_encoder_layers if hasattr(args.Model, 'num_encoder_layers') else 2
    num_decoder_layers = args.Model.num_decoder_layers if hasattr(args.Model, 'num_decoder_layers') else 2
    dim_feedforward = args.Model.dim_feedforward if hasattr(args.Model, 'dim_feedforward') else 2048
    num_queries = args.Model.num_queries if hasattr(args.Model, 'num_queries') else 10
    num_feature_levels = args.Model.num_feature_levels if hasattr(args.Model, 'num_feature_levels') else 1
    enc_n_points = args.Model.enc_n_points if hasattr(args.Model, 'enc_n_points') else 4
    dec_n_points = args.Model.dec_n_points if hasattr(args.Model, 'dec_n_points') else 4
