...
def process_S4_MIL(args):
    ...
    d_state = args.Model.d_state if hasattr(args.Model, 'd_state') else 32
    n_layers = args.Model.n_layers if hasattr(args.Model, 'n_layers') else 1
