...
def process_MICO_MIL(args):
    ...
    embedding_dim = args.Model.embedding_dim if hasattr(args.Model, 'embedding_dim') else 512
    num_clusters = args.Model.num_clusters if hasattr(args.Model, 'num_clusters') else 64
    num_enhancers = args.Model.num_enhancers if hasattr(args.Model, 'num_enhancers') else 3
    drop = args.Model.dropout
    hard = args.Model.hard if hasattr(args.Model, 'hard') else False
    similarity_method = args.Model.similarity_method if hasattr(args.Model, 'similarity_method') else 'l2'
    cluster_init_path = args.Model.cluster_init_path if hasattr(args.Model, 'cluster_init_path') else None
