...
def process_MR_AB_MIL(args):
    ...
    mil_model = MR_AB_MIL(
        ...
        attention_dim=args.Model.get('attention_dim', 256),
        num_classes=num_classes,
        rank=args.Model.get('rank', 64),
        residual_alpha=args.Model.get('residual_alpha', 1.0),
        residual_dropout=args.Model.get('residual_dropout', 0.0),
